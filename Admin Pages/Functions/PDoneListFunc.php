...
$queryPNumD = "SELECT * FROM (SELECT ohistory.OH_ID, ohistory.OrderID, ohistory.Order_Price, ohistory.Date, ohistory.Time, ohistory.State, ohistory.AccountID, ohistory.Msg, accounts.Account_Type
...
while ($row = mysqli_fetch_assoc($resultPDone)) {
